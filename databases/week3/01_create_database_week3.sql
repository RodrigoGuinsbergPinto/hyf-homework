...
CREATE TABLE `reservation` (
    `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `number_of_guests` INT(10) UNSIGNED NULL,
...
INSERT INTO meal (`id`, `title`, `description`, `location`, `when`, `max_reservations`, `price`, `created_date`)
VALUES (3, 'Pollo alla Siciliana', 'chicken breast topped with mozzarella & parma ham, cooked in a tomato sauce served with chips an peas.', 'østerbro', '2023-03-05 18:30:00', 20, 160, current_date());
INSERT INTO meal (`id`, `title`, `description`, `location`, `when`, `max_reservations`, `price`, `created_date`)
